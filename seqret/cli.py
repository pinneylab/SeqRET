...
def main():
    ...
    parser_optimize.add_argument('-o', '--output_csv', type=str, help='Output CSV file to write optimized sequences')
    parser_optimize.add_argument('--filters', type=str, nargs='+', help='List of filters to apply (by title)')
